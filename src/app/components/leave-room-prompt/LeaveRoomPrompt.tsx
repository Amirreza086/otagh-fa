      ...
      <OverlayCenter>
        ...
        >
          <Dialog variant="Surface">
            ...
            >
              <Box grow="Yes">
                <Text size="H4">ترک کردن اتاق</Text>
              </Box>
            ...
            <Box style={{ padding: config.space.S400 }} direction="Column" gap="400">
              <Box direction="Column" gap="200">
                <Text priority="400">آیا مطمئنید که می خواهید از این اتاق خارج شوید؟</Text>
                {leaveState.status === AsyncStatus.Error && (
                  <Text style={{ color: color.Critical.Main }} size="T300">
                    ترک اتاق ناموفق بود! {leaveState.error.message}
                  </Text>
                )}
              </Box>
              <Button
              ...
              >
                <Text size="B400">
                  {leaveState.status === AsyncStatus.Loading ? 'در حال ترک کردن...' : 'ترک انجام شد'}
                </Text>
              </Button>
            </Box>
          </Dialog>
